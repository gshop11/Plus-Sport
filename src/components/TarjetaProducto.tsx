...
import { getProductoCardStock } from '@/lib/availability-inquiry'
import { formatMoney } from '@/lib/money'
import type { ProductoCard } from '@/lib/storefront-types'

export type { ProductoCard } from '@/lib/storefront-types'
...
export default function TarjetaProducto({
  ...
  const isInquiryOnly = getProductoCardStock(producto) <= 0
